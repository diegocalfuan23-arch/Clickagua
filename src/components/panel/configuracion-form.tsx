...
function Campo({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      {children}
      {ayuda && (
        <p className="text-[0.8rem] text-muted-foreground">{ayuda}</p>
      )}
    </div>
  );
}
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <Campo id="nombre" label="Nombre del comité">
            <Input id="nombre" name="nombre" defaultValue={datos.nombre} required />
          </Campo>
          <Campo
            id="razonSocial"
            label="Razón social"
          ...
          <Campo id="comuna" label="Comuna">
            <Input id="comuna" name="comuna" defaultValue={datos.comuna} required />
          </Campo>
          <Campo id="region" label="Región">
            <Input id="region" name="region" defaultValue={datos.region ?? ""} />
          </Campo>
