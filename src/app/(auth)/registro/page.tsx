...
export const metadata: Metadata = {
  title: "Registrar mi APR — ClickAgua",
  description:
    "Crea la cuenta de tu APR o SSR en ClickAgua y empieza a responder consultas de socios por WhatsApp.",
};
  ...
  return (
    <div className="w-full max-w-[540px]">
      <h1 className="text-[1.6rem] font-semibold tracking-tight">
        Registra tu comité en ClickAgua
      </h1>
